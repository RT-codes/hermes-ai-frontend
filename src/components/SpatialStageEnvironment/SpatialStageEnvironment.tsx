...
type SpatialStageEnvironmentProps = {
...
export function SpatialStageEnvironment({ viewRotation = { yaw: 0, pitch: 0 }, className = '' }: SpatialStageEnvironmentProps) {
  ...
  return (
    <div className={`spatial-stage-environment ${className}`.trim()} aria-hidden="true">
      <SpatialStageBackdrop />

      <div className={`brain-scene-core ${isThinking ? 'is-thinking' : 'is-idle'}`}>
