...
/**
 * Canonical diagnostic layout contracts. These rectangles describe intended
 * ownership regions only; they do not position production panels until a later
 * migration explicitly adopts a zone.
 */
